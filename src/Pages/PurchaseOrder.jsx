    ...
    const handleView = async (id) => {
        ...
        if (po) {
            ...
            const formattedProducts = po.products.map((p) => ({
                ...
                uom:
                    p.uom ||
                    Inventorydata.find(i => i.name === p.item_name)?.uom ||
                    "",
                product_type:
                    p.product_type ||
                    Inventorydata.find(i => i.name === p.item_name)?.product_or_service ||
                    "",
            }));
                ...
                <table className="min-w-full border-collapse text-sm text-left">
                    <thead>
                        <tr className="bg-gradient-to-r from-blue-600 to-sky-500 text-white uppercase text-xs tracking-wide">
                            {["PO No", "Supplier", "Product Count", "Status", "Actions"].map((h, i) => (
                    ...
                    <tbody>
                        {loading ? (
                            ...
                            POData.pos.map((order, i) => (
                                <tr
                                    key={order._id}
                                    className={`transition-all ${i % 2 ? "bg-white" : "bg-gray-50"
                                        } hover:bg-blue-50`}
                                >
                    ...
                    <div className="bg-white w-full max-w-2xl h-full shadow-2xl transform transition-all duration-500 ease-out">
                        ...
                        <div className="p-6 overflow-y-auto max-h-[85vh]">
                            <form onSubmit={formik.handleSubmit} className="space-y-6">
                                {/* Supplier Dropdown */}
                                <div>
                                    <label className="block text-gray-700 font-medium mb-1">Select Supplier</label>
                                    <select
                                        name="supplier"
                                ...
                                {products.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <label className="block text-gray-700 font-medium mb-1">UOM</label>
                                                <input
                                                    type="text"
                                                    value={item.uom}
                                                    readOnly
                                            ...
                                            {["est_quantity", "produce_quantity", "remain_quantity"].map((field) => (
                                                <div key={field}>
