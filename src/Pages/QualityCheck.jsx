...
// import { useQualityCheck } from "../Context/QualityCheckContext.jsx";
...
//   const [showGtModal, ] = useState(false);
//   const [pendingData, setPendingData] setShowGtModal= useState();
...
const QualityCheck = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    data.append("approvedQty", formData.approvedQty);
    data.append("rejectedQty", formData.rejectedQty);
    data.append("status", formData.status);
    if (formData.attached_report)
      data.append("attached_report", formData.attached_report);

    if (selectedReport?._id) await updateReport({ ...formData, _id: selectedReport._id });
    else await createReport(data);
